---
title: 'Walkthrough: Build your first hybrid app with Maui Blazor Bindings - Maui Blazor Bindings'
ms.topic: tutorial
ms.prod: aspnet-core
---
...
The easiest way to get started with Experimental Maui Blazor Bindings to build hybrid apps is to create the initial project from the command line. This template supports creating apps for Android, iOS, WPF (Windows), and macOS.
...
1. Congratulations, you've created and run your first Experimental Maui Blazor Bindings hybrid app!
