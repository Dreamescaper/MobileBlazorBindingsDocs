...
Because most of the built-in UI components are based on MAUI controls, you can refer to the [MAUI Controls Reference](https://docs.microsoft.com/xamarin/xamarin-forms/user-interface/controls/) to learn more about how they work and their properties and events.
